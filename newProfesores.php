...
.btn-agregar:active {
    ...
    <div class="main-wrapper">
        ...
        <div class="panel-izquierdop">
            <h1>LIVELULA</h1>
            <p style="opacity: 0.5;" id="infoini">Sistema de Biometría</p>
        </div>
    ...
    <script>
        ...
        async function cargarProfesores() {
            ...
            listarProfesores();
            window.cargarDatosAsis?.();
        }
        function listarProfesores(){
            document.getElementById("listado").innerHTML="";
            if (!Array.isArray(datosProfesores) || datosProfesores.length === 0) {msj("lista de profesores vacía",2);return; }
        ...
        document.getElementById('lupa').addEventListener('input',listarProfesores);
        // --- LÓGICA DEL PANEL ---
